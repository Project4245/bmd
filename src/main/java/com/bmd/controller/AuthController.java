...
public class AuthController {
	...
	public ResponseEntity<String> sendOtp(@RequestParam String mobileNumber) {
		...
		return new ResponseEntity(Map.of("message", otp), HttpStatus.OK);
//		return ResponseEntity.ok("Otp is :: " + otp);
	...
	private void authenticate(String username, String password) throws Exception {
		...
		try {
			System.out.println("Incajljkhkkj");
...
//	}
	...
	public ResponseEntity<UserDto> getUser(Principal principal) {
		User user = this.userRepo.findByMobileNumber(principal.getName()).get();
